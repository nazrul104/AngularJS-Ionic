...
class UserProfile extends REST
{
	...
	{		
		...
		{
			$arr = array();
			$fname =  mysqli_real_escape_string($this->mysqli,$_POST['fname']);
			$lname =  mysqli_real_escape_string($this->mysqli,$_POST['lname']);
			$email =  mysqli_real_escape_string($this->mysqli,$_POST['email']);
			$mobile =  mysqli_real_escape_string($this->mysqli,$_POST['mobile_no']);
			$telno =  mysqli_real_escape_string($this->mysqli,$_POST['telephone_no']);		
			$postcode =  mysqli_real_escape_string($this->mysqli,$_POST['postcode']);
			$address1 =  mysqli_real_escape_string($this->mysqli,$_POST['address1']);
			$address2 =  mysqli_real_escape_string($this->mysqli,$_POST['address2']);
			$city =  mysqli_real_escape_string($this->mysqli,$_POST['city']);
			$country =  mysqli_real_escape_string($this->mysqli,$_POST['country']);
			$dob =  mysqli_real_escape_string($this->mysqli,$_POST['dob_date']);
			$dateOfAniversary =  mysqli_real_escape_string($this->mysqli,$_POST['doa']);
